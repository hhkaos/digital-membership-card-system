...
export function I18nProvider({ children }) {
  ...
  const value = useMemo(() => {
    ...
    const formatDate = (unixSeconds) => formatDateForLocale(unixSeconds, safeLanguage);

    return { language: safeLanguage, setLanguage: setLanguageWithPersistence, t, formatDate };
  }, [language]);
