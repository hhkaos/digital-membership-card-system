  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h1 style={{ ...styles.heading, color: "#28a745" }}>
          {t("valid.title")}
        </h1>
        <p style={styles.memberName}>{memberName}</p>
        <p style={styles.expiryText}>
          {t("valid.validUntil", { date: formattedDate })}
        </p>
        {revocationWarning && (
          <div
            style={{
...
export const InvalidState = ({
  ...
  const helper = isRevoked
    ? t("invalid.contactRestore")
      ...
      <div style={styles.card}>
        ...
        {errorDetails && (
          <div style={styles.details}>
            ...
            >
              {showDetails
                ? t("invalid.hideTechnicalDetails")
                : t("invalid.showTechnicalDetails")}
            </button>
            {showDetails && (
              <div style={styles.detailsContent}>{errorDetails}</div>
            )}
          </div>
        )}
